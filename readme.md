...
Для заданного числа входов $n$ и максимальной степени $d$ генерируем все возможные мультииндексы $(\alpha_1, \alpha_2, \ldots, \alpha_n)$ такие, что:
...
2. **Выбор метода инициализации**:
   ...
   - `he` (метод Kaiming He) - рекомендуется для сетей с функцией ReLU и её вариациями;
   - `small_random`;
...
5. **Архитектура сети**: комбинируйте Sigma-Pi слои с обычными полносвязными слоями для лучшей эффективности.
